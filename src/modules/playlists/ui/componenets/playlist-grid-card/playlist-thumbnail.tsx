    ...
    <div className={cn("relative pt-3", className)}>
      ...
      <div className="relative">
        ...
        <div className="relative overflow-hidden w-full rounded-xl aspect-video">
          ...
          {/* HOVER OVERLAY */}
          <div
            className="absolute inset-0 bg-black/45 opacity-0 group-hover:opacity-100
      ...
      {/* VIDEO COUNT */}
      <div
        className="absolute bottom-2 right-2 px-1 py-0.5 rounded bg-black/80 text-white
